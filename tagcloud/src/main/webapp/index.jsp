        ...
        <table width="100%">
          <tr>
            <td align="center" valign="top" colspan="2">
              <textarea name="text" rows="5" cols="50"><%= text %>
              </textarea>
            </td>
          </tr>
          <tr>
            <td align="left" valign="top">
              <input type="button" value="Clear Cloud"
                     onclick="document.startform.command.value='CLEAR'; document.startform.submit();"/>
            </td>
            <td align="right" valign="top">
              <input type="button" value="Generate Cloud"
                     onclick="document.startform.command.value='SEARCH'; document.startform.submit();"/>
            </td>
          </tr>
        </table>
