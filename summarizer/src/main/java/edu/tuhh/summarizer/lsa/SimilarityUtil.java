...
class SimilarityUtil {
  ...
  protected static double getCosineSimilarity(DoubleVector vect1, DoubleVector vect2) {
   ...
   * cosim(a,b) = (a . b)/(||a||.||b||)
   */
  protected static double getSimilarityBetweenVectors(double[] a, double[] b) {
   ...
   */
  protected static double getDotProduct(double[] a, double[] b) {
    int length = a.length;
    double sum = 0.0;
    if (length != b.length) {
   ...
   */
  protected static double getFrobeniusNorm(double[] a, double[] b) {
   ...
   */
  protected static double fNorm(double[] a) {
    double sum = 0;
