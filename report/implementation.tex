...
The Tag cloud summarizer is a tool that should aid users to obtain a quick overview of the main concepts contained in search results they receive. It should be used by users, and can be evaluated best by them. In Chapter~\ref.{chapter:evaluation} an simple evaluation based on user feedback is provided. 
