...
In this work we evaluate the cluster labeling algorithm Weighted Centroid Covering.  use the k-means algorithm in order to cluster documents, which we need for the evaluation of cluster labeling algorithm~\gls{WCC}. Two factors influence this implementation decision:
\begin{itemize}
...
In algorithm~\ref{algorithm_kmeans} we give as pseudo-code a detailed step-by-step description of the k-means algorithm. \\
