...
\section{TODO: Cluster labeling using external knowledge}

\subsection{TODO: Ontology as a source of external knowledge}
It is not the topic of this work to investigate into semantic knowledge and ontologies. Therefore, we will not offer here extensive definitions on ontologies. \\
...
- The authors of \gls{WCC} point out that this the algorithm could be extended to use existing ontologies and labels, but they provide no experimental results of any kind. \\
...
We propose using external knowledge during extraction of candidate labels phase~(fig.~\ref{fig_wcc_onto}). \\
