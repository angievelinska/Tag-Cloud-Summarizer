...
public class LatentSemanticAnalysisTest {
  ...
  public void testLSA(){
    ...
    for (int i=0; i<9; i++){
      ...
      double cosim2 = SimilarityUtil.getSimilarityBetweenVectors(doc.toArray(), query.toArray());
  ...
  public List<Document> getDocuments(){
    ...
    for (int i=0; i<documents.length; i++){
      edu.tuhh.tagcloudsummarizer.common.Document doc = new DocumentImpl(i, documents[i]);
      docs.add(doc);
    }
